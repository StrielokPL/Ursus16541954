...
## Najnowszy test: 1.1.1.2 P2

[Pełny prerelease P2](https://github.com/StrielokPL/Ursus16541954/releases/tag/1.1.1.2P2), [zmiany i test aktualizatora](docs/releases/1.1.1.2P2.md), [reguły i dowody P2](docs/transmission-P2.md). Diagnostyka D3 pozostaje zgodna.

## Poprzednia wersja testowa 1.1.1.1 P1
